...
import { ArrowLeft, Loader2, X, Plus, ImagePlus } from "lucide-react";
          ...
          <Section title="Property Details">
            <div className="grid grid-cols-3 gap-4">
              ...
              <Field label="Bathrooms" error={errors.bathrooms?.message} required>
                <Input {...register("bathrooms", { valueAsNumber: true })} type="number" min={0} max={20} />
              </Field>
              <Field label="Size (sq ft)" error={errors.size?.message}>
                <Input {...register("size", { valueAsNumber: true })} type="number" min={0} placeholder="Optional" />
              </Field>
            </div>
          ...
          <Section title="Pricing" description="মাসিক ভাড়া ও অন্যান্য চার্জ">
            <div className="grid grid-cols-3 gap-4">
              <Field label="Rent / Month (৳)" error={errors.rentAmount?.message} required>
                <Input {...register("rentAmount", { valueAsNumber: true })} type="number" min={0} placeholder="e.g. 15000" />
              </Field>
              <Field label="Advance Deposit (৳)" error={errors.advanceDeposit?.message}>
                <Input {...register("advanceDeposit", { valueAsNumber: true })} type="number" min={0} />
              </Field>
              <Field label="Booking Fee (৳)" error={errors.bookingFee?.message}>
                <Input {...register("bookingFee", { valueAsNumber: true })} type="number" min={0} />
              </Field>
            </div>
