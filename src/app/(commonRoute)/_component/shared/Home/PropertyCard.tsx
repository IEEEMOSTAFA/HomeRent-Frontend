...
export default function PropertyCard({ property }: PropertyCardProps) {
  ...
  return (
    <Link href={`/property/${property.id}`} className="group block">
      <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl overflow-hidden hover:shadow-xl transition-all duration-300 h-full flex flex-col">
        ...
        <div className="p-5 flex flex-col flex-1">
          ...
          {property.rating && property.rating > 0 && (
            <div className="flex items-center gap-1 text-sm mt-auto pt-4 border-t">
