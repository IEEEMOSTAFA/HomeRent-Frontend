...
// //     // ✅ হওয়া উচিত — analytics-এর মতো unwrap করতে হবে
// // queryFn: async () => {
// //   const res: any = await apiFetch("/admin/reviews/flagged");
// //   if (res?.success === true && res?.data) return res; // meta সহ পুরোটা
// //   return res;
// // },
// //   });
// // }
...
// // পরে — backend wrapper handle করা হয়েছে
...
//       // Backend { success, data, meta } format unwrap
//       if (res?.success === true) {
//         return {
//           data: res.data ?? [],
//           meta: res.meta ?? res.pagination ?? { total: 0, page: 1, pageSize: 10, totalPages: 0 },
//         };
//       }

//       // Fallback: সরাসরি data array আসলে
//       if (Array.isArray(res)) {
//         return { data: res, meta: { total: res.length, page: 1, pageSize: res.length, totalPages: 1 } };
//       }
